...
public class MkdirAndRm {
	...
	public static void main(String[] args) {
		...
		try{
			if(MkdirAndRm.test(conf,remoteFilePath)){
				MkdirAndRm.rm(conf,remoteFilePath);
				System.out.print("delete " + remoteFilePath);
			
			}else{
				if(!MkdirAndRm.test(conf,remoteDir)){
					MkdirAndRm.mkdir(conf,remoteDir);
				}
				MkdirAndRm.touchz(conf,remoteFilePath);
